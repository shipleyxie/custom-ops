...
ZERO_OUT_SRCS = $(wildcard tensorflow_time_two/cc/kernels/*.cc) $(wildcard tensorflow_time_two/cc/kernels/*.h) $(wildcard tensorflow_time_two/cc/ops/*.cc)
...
CFLAGS = ${TF_CFLAGS} -fPIC -g -std=c++11
